...
func (c *relayClient) StreamBlock(ctx context.Context, in *StreamBlockRequest, opts ...grpc.CallOption) (Relay_StreamBlockClient, error) {
	stream, err := c.cc.NewStream(ctx, &Relay_ServiceDesc.Streams[1], Relay_StreamBlock_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &relayStreamBlockClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Relay_StreamBlockClient interface {
	Recv() (*StreamBlockResponse, error)
	grpc.ClientStream
}

type relayStreamBlockClient struct {
	grpc.ClientStream
}

func (x *relayStreamBlockClient) Recv() (*StreamBlockResponse, error) {
...
func (c *relayClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, Relay_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relayClient) AdjustLatestBlockPayload(ctx context.Context, in *AdjustLatestBlockPayloadRequest, opts ...grpc.CallOption) (*AdjustLatestBlockPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, Relay_AdjustLatestBlockPayload_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Relay_StreamBlock_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RelayServer).StreamBlock(m, &relayStreamBlockServer{stream})
}

type Relay_StreamBlockServer interface {
	Send(*StreamBlockResponse) error
	grpc.ServerStream
}

type relayStreamBlockServer struct {
	grpc.ServerStream
}

func (x *relayStreamBlockServer) Send(m *StreamBlockResponse) error {
	return x.ServerStream.SendMsg(m)
}
