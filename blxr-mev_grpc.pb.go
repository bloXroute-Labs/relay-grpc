...
const (
	...
	Relay_GetPayloadV2_FullMethodName             = "/Relay/GetPayloadV2"
...
type RelayClient interface {
	...
	GetPayloadV2(ctx context.Context, in *GetPayloadV2Request, opts ...grpc.CallOption) (*GetPayloadV2Response, error)
...
func (c *relayClient) GetPayloadV2(ctx context.Context, in *GetPayloadV2Request, opts ...grpc.CallOption) (*GetPayloadV2Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPayloadV2Response)
	err := c.cc.Invoke(ctx, Relay_GetPayloadV2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RelayServer interface {
	...
	GetPayloadV2(context.Context, *GetPayloadV2Request) (*GetPayloadV2Response, error)
...
func (UnimplementedRelayServer) GetPayloadV2(context.Context, *GetPayloadV2Request) (*GetPayloadV2Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPayloadV2 not implemented")
}
...
func _Relay_GetPayloadV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPayloadV2Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayServer).GetPayloadV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Relay_GetPayloadV2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayServer).GetPayloadV2(ctx, req.(*GetPayloadV2Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Relay_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPayloadV2",
			Handler:    _Relay_GetPayloadV2_Handler,
		},
		{
