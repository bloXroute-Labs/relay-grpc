...
const (
	...
	Relay_StreamOptimisticBlock_FullMethodName    = "/Relay/StreamOptimisticBlock"
...
type RelayClient interface {
	...
	StreamOptimisticBlock(ctx context.Context, in *StreamOptimisticBlockRequest, opts ...grpc.CallOption) (Relay_StreamOptimisticBlockClient, error)
...
func (c *relayClient) StreamOptimisticBlock(ctx context.Context, in *StreamOptimisticBlockRequest, opts ...grpc.CallOption) (Relay_StreamOptimisticBlockClient, error) {
	stream, err := c.cc.NewStream(ctx, &Relay_ServiceDesc.Streams[1], Relay_StreamOptimisticBlock_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &relayStreamOptimisticBlockClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Relay_StreamOptimisticBlockClient interface {
	Recv() (*StreamOptimisticBlockResponse, error)
	grpc.ClientStream
}

type relayStreamOptimisticBlockClient struct {
	grpc.ClientStream
}

func (x *relayStreamOptimisticBlockClient) Recv() (*StreamOptimisticBlockResponse, error) {
	m := new(StreamOptimisticBlockResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type RelayServer interface {
	...
	StreamOptimisticBlock(*StreamOptimisticBlockRequest, Relay_StreamOptimisticBlockServer) error
...
func (UnimplementedRelayServer) StreamOptimisticBlock(*StreamOptimisticBlockRequest, Relay_StreamOptimisticBlockServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamOptimisticBlock not implemented")
}
...
func _Relay_StreamOptimisticBlock_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamOptimisticBlockRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RelayServer).StreamOptimisticBlock(m, &relayStreamOptimisticBlockServer{stream})
}

type Relay_StreamOptimisticBlockServer interface {
	Send(*StreamOptimisticBlockResponse) error
	grpc.ServerStream
}

type relayStreamOptimisticBlockServer struct {
	grpc.ServerStream
}

func (x *relayStreamOptimisticBlockServer) Send(m *StreamOptimisticBlockResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var Relay_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "StreamOptimisticBlock",
			Handler:       _Relay_StreamOptimisticBlock_Handler,
			ServerStreams: true,
		},
	},
