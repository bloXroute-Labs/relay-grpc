...
func (x *SubmitBlockRequest) Reset() {
	*x = SubmitBlockRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regional_relay_proto_msgTypes[0]
...
func (*SubmitBlockRequest) Descriptor() ([]byte, []int) {
	return file_regional_relay_proto_rawDescGZIP(), []int{0}
}
...
func (x *SubmitBlockResponse) Reset() {
	*x = SubmitBlockResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regional_relay_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SubmitBlockResponse) Descriptor() ([]byte, []int) {
	return file_regional_relay_proto_rawDescGZIP(), []int{1}
}
...
func (x *BidTrace) Reset() {
	*x = BidTrace{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regional_relay_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BidTrace) Descriptor() ([]byte, []int) {
	return file_regional_relay_proto_rawDescGZIP(), []int{2}
}
...
func (x *Withdrawal) Reset() {
	*x = Withdrawal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regional_relay_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Withdrawal) Descriptor() ([]byte, []int) {
	return file_regional_relay_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExecutionPayload) Reset() {
	*x = ExecutionPayload{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regional_relay_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExecutionPayload) Descriptor() ([]byte, []int) {
	return file_regional_relay_proto_rawDescGZIP(), []int{4}
}
...
func (x *CompressTx) Reset() {
	*x = CompressTx{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regional_relay_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompressTx) Descriptor() ([]byte, []int) {
	return file_regional_relay_proto_rawDescGZIP(), []int{5}
}
...
var File_regional_relay_proto protoreflect.FileDescriptor

var file_regional_relay_proto_rawDesc = []byte{
	0x0a, 0x14, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x2d, 0x72, 0x65, 0x6c, 0x61, 0x79,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x02, 0x0a, 0x12, 0x53, 0x75, 0x62, 0x6d, 0x69,
	0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x25, 0x0a,
	0x08, 0x62, 0x69, 0x64, 0x54, 0x72, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11,
	...
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x73, 0x69, 0x7a, 0x65, 0x42, 0x65, 0x66,
	0x6f, 0x72, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x67, 0x65, 0x74, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x67,
	...
	0x75, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22,
	...
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x8e, 0x04,
	...
	0x0f, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x47, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64, 0x22, 0x40,
	...
	0x32, 0x4b, 0x0a, 0x0d, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x6c, 0x61,
	...
	0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x33, 0x5a,
	...
	0x67, 0x72, 0x70, 0x63, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x72, 0x65, 0x6c,
	0x61, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_regional_relay_proto_rawDescOnce sync.Once
	file_regional_relay_proto_rawDescData = file_regional_relay_proto_rawDesc
)

func file_regional_relay_proto_rawDescGZIP() []byte {
	file_regional_relay_proto_rawDescOnce.Do(func() {
		file_regional_relay_proto_rawDescData = protoimpl.X.CompressGZIP(file_regional_relay_proto_rawDescData)
	})
	return file_regional_relay_proto_rawDescData
}

var file_regional_relay_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_regional_relay_proto_goTypes = []interface{}{
	(*SubmitBlockRequest)(nil),  // 0: SubmitBlockRequest
	(*SubmitBlockResponse)(nil), // 1: SubmitBlockResponse
	(*BidTrace)(nil),            // 2: BidTrace
	(*Withdrawal)(nil),          // 3: Withdrawal
	(*ExecutionPayload)(nil),    // 4: ExecutionPayload
	(*CompressTx)(nil),          // 5: compressTx
}
var file_regional_relay_proto_depIdxs = []int32{
	2, // 0: SubmitBlockRequest.bidTrace:type_name -> BidTrace
	4, // 1: SubmitBlockRequest.executionPayload:type_name -> ExecutionPayload
	5, // 2: ExecutionPayload.Transactions:type_name -> compressTx
	3, // 3: ExecutionPayload.Withdrawals:type_name -> Withdrawal
	0, // 4: RegionalRelay.SubmitBlock:input_type -> SubmitBlockRequest
	1, // 5: RegionalRelay.SubmitBlock:output_type -> SubmitBlockResponse
...
func init() { file_regional_relay_proto_init() }
func file_regional_relay_proto_init() {
	if File_regional_relay_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_regional_relay_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regional_relay_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regional_relay_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regional_relay_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regional_relay_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regional_relay_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_regional_relay_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_regional_relay_proto_goTypes,
		DependencyIndexes: file_regional_relay_proto_depIdxs,
		MessageInfos:      file_regional_relay_proto_msgTypes,
	}.Build()
	File_regional_relay_proto = out.File
	file_regional_relay_proto_rawDesc = nil
	file_regional_relay_proto_goTypes = nil
	file_regional_relay_proto_depIdxs = nil
}
