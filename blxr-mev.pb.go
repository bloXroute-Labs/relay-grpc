...
var file_blxr_mev_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xfd,
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x43,
	...
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xdb, 0x04, 0x0a, 0x0b, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65,
	...
	0x64, 0x49, 0x6e, 0x32, 0xdc, 0x05, 0x0a, 0x05, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x3a, 0x0a,
...
var file_blxr_mev_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_blxr_mev_proto_goTypes = []interface{}{
	...
	(*ExecutionRequests)(nil),                // 23: ExecutionRequests
	(*DepositRequest)(nil),                   // 24: DepositRequest
	(*WithdrawalRequest)(nil),                // 25: WithdrawalRequest
	(*ConsolidationRequest)(nil),             // 26: ConsolidationRequest
	(*StreamBuilderRequest)(nil),             // 27: StreamBuilderRequest
	(*StreamBuilderResponse)(nil),            // 28: StreamBuilderResponse
	(*BuilderInfo)(nil),                      // 29: BuilderInfo
	(*timestamppb.Timestamp)(nil),            // 30: google.protobuf.Timestamp
}
var file_blxr_mev_proto_depIdxs = []int32{
	30, // 0: RegisterValidatorRequest.received_at:type_name -> google.protobuf.Timestamp
	30, // 1: GetPayloadRequest.received_at:type_name -> google.protobuf.Timestamp
	30, // 2: StreamHeaderResponse.send_time:type_name -> google.protobuf.Timestamp
	30, // 3: StreamHeaderResponse.relay_receive_time:type_name -> google.protobuf.Timestamp
	16, // 4: StreamBlockResponse.grpc_payload:type_name -> SubmitBlockRequest
	30, // 5: StreamBlockResponse.send_time:type_name -> google.protobuf.Timestamp
	30, // 6: StreamBlockResponse.relay_receive_time:type_name -> google.protobuf.Timestamp
	30, // 7: PreFetchGetPayloadRequest.received_at:type_name -> google.protobuf.Timestamp
	...
	23, // 11: SubmitBlockRequest.executionRequests:type_name -> ExecutionRequests
	22, // 12: ExecutionPayload.Transactions:type_name -> compressTx
	19, // 13: ExecutionPayload.Withdrawals:type_name -> Withdrawal
	24, // 14: ExecutionRequests.deposits:type_name -> DepositRequest
	25, // 15: ExecutionRequests.withdrawals:type_name -> WithdrawalRequest
	26, // 16: ExecutionRequests.consolidations:type_name -> ConsolidationRequest
	29, // 17: StreamBuilderResponse.builder_info:type_name -> BuilderInfo
	16, // 18: Relay.SubmitBlock:input_type -> SubmitBlockRequest
	2,  // 19: Relay.RegisterValidator:input_type -> RegisterValidatorRequest
	6,  // 20: Relay.GetHeader:input_type -> GetHeaderRequest
	8,  // 21: Relay.GetPayload:input_type -> GetPayloadRequest
	10, // 22: Relay.StreamHeader:input_type -> StreamHeaderRequest
	12, // 23: Relay.StreamBlock:input_type -> StreamBlockRequest
	13, // 24: Relay.ForwardBlock:input_type -> StreamBlockResponse
	4,  // 25: Relay.GetValidatorRegistration:input_type -> GetValidatorRegistrationRequest
	14, // 26: Relay.PreFetchGetPayload:input_type -> PreFetchGetPayloadRequest
	27, // 27: Relay.StreamBuilder:input_type -> StreamBuilderRequest
	0,  // 28: Relay.Ping:input_type -> PingRequest
	17, // 29: Relay.SubmitBlock:output_type -> SubmitBlockResponse
	3,  // 30: Relay.RegisterValidator:output_type -> RegisterValidatorResponse
	7,  // 31: Relay.GetHeader:output_type -> GetHeaderResponse
	9,  // 32: Relay.GetPayload:output_type -> GetPayloadResponse
	11, // 33: Relay.StreamHeader:output_type -> StreamHeaderResponse
	13, // 34: Relay.StreamBlock:output_type -> StreamBlockResponse
	17, // 35: Relay.ForwardBlock:output_type -> SubmitBlockResponse
	5,  // 36: Relay.GetValidatorRegistration:output_type -> GetValidatorRegistrationResponse
	15, // 37: Relay.PreFetchGetPayload:output_type -> PreFetchGetPayloadResponse
	28, // 38: Relay.StreamBuilder:output_type -> StreamBuilderResponse
	1,  // 39: Relay.Ping:output_type -> PingResponse
