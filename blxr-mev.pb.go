...
var file_blxr_mev_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x22, 0x84, 0x02,
	...
	0x4f, 0x6e, 0x6c, 0x79, 0x22, 0x43, 0x0a, 0x13, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x42, 0x6c,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xd6, 0x04, 0x0a,
...
var file_blxr_mev_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_blxr_mev_proto_goTypes = []interface{}{
	...
	(*ExecutionPayload)(nil),          // 12: ExecutionPayload
	(*CompressTx)(nil),                // 13: compressTx
	(*timestamppb.Timestamp)(nil),     // 14: google.protobuf.Timestamp
}
var file_blxr_mev_proto_depIdxs = []int32{
	14, // 0: RegisterValidatorRequest.received_at:type_name -> google.protobuf.Timestamp
	14, // 1: GetPayloadRequest.received_at:type_name -> google.protobuf.Timestamp
	10, // 2: SubmitBlockRequest.bidTrace:type_name -> BidTrace
	12, // 3: SubmitBlockRequest.executionPayload:type_name -> ExecutionPayload
	13, // 4: ExecutionPayload.Transactions:type_name -> compressTx
	11, // 5: ExecutionPayload.Withdrawals:type_name -> Withdrawal
	8,  // 6: Relay.SubmitBlock:input_type -> SubmitBlockRequest
	0,  // 7: Relay.RegisterValidator:input_type -> RegisterValidatorRequest
	2,  // 8: Relay.GetHeader:input_type -> GetHeaderRequest
	4,  // 9: Relay.GetPayload:input_type -> GetPayloadRequest
	6,  // 10: Relay.StreamHeader:input_type -> StreamHeaderRequest
	9,  // 11: Relay.SubmitBlock:output_type -> SubmitBlockResponse
	1,  // 12: Relay.RegisterValidator:output_type -> RegisterValidatorResponse
	3,  // 13: Relay.GetHeader:output_type -> GetHeaderResponse
	5,  // 14: Relay.GetPayload:output_type -> GetPayloadResponse
	7,  // 15: Relay.StreamHeader:output_type -> StreamHeaderResponse
