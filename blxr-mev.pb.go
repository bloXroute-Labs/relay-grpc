...
var file_blxr_mev_proto_rawDesc = []byte{
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xfd, 0x04, 0x0a, 0x12, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74,
	...
	0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x43, 0x0a, 0x13, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x42,
	...
	0x09, 0x69, 0x73, 0x4f, 0x70, 0x74, 0x65, 0x64, 0x49, 0x6e, 0x32, 0xb5, 0x05, 0x0a, 0x05, 0x52,
...
var file_blxr_mev_proto_goTypes = []interface{}{
	...
	(*CompressTx)(nil),                       // 20: compressTx
	(*ExecutionRequests)(nil),                // 21: ExecutionRequests
	(*DepositRequest)(nil),                   // 22: DepositRequest
	(*WithdrawalRequest)(nil),                // 23: WithdrawalRequest
	(*ConsolidationRequest)(nil),             // 24: ConsolidationRequest
	(*StreamBuilderRequest)(nil),             // 25: StreamBuilderRequest
	(*StreamBuilderResponse)(nil),            // 26: StreamBuilderResponse
	(*BuilderInfo)(nil),                      // 27: BuilderInfo
...
var file_blxr_mev_proto_depIdxs = []int32{
	...
	21, // 11: SubmitBlockRequest.executionRequests:type_name -> ExecutionRequests
	20, // 12: ExecutionPayload.Transactions:type_name -> compressTx
	17, // 13: ExecutionPayload.Withdrawals:type_name -> Withdrawal
	22, // 14: ExecutionRequests.deposits:type_name -> DepositRequest
	23, // 15: ExecutionRequests.withdrawals:type_name -> WithdrawalRequest
	24, // 16: ExecutionRequests.consolidations:type_name -> ConsolidationRequest
	27, // 17: StreamBuilderResponse.builder_info:type_name -> BuilderInfo
	14, // 18: Relay.SubmitBlock:input_type -> SubmitBlockRequest
	0,  // 19: Relay.RegisterValidator:input_type -> RegisterValidatorRequest
	4,  // 20: Relay.GetHeader:input_type -> GetHeaderRequest
	6,  // 21: Relay.GetPayload:input_type -> GetPayloadRequest
	8,  // 22: Relay.StreamHeader:input_type -> StreamHeaderRequest
	10, // 23: Relay.StreamBlock:input_type -> StreamBlockRequest
	11, // 24: Relay.ForwardBlock:input_type -> StreamBlockResponse
	2,  // 25: Relay.GetValidatorRegistration:input_type -> GetValidatorRegistrationRequest
	12, // 26: Relay.PreFetchGetPayload:input_type -> PreFetchGetPayloadRequest
	25, // 27: Relay.StreamBuilder:input_type -> StreamBuilderRequest
	15, // 28: Relay.SubmitBlock:output_type -> SubmitBlockResponse
	1,  // 29: Relay.RegisterValidator:output_type -> RegisterValidatorResponse
	5,  // 30: Relay.GetHeader:output_type -> GetHeaderResponse
	7,  // 31: Relay.GetPayload:output_type -> GetPayloadResponse
	9,  // 32: Relay.StreamHeader:output_type -> StreamHeaderResponse
	11, // 33: Relay.StreamBlock:output_type -> StreamBlockResponse
	15, // 34: Relay.ForwardBlock:output_type -> SubmitBlockResponse
	3,  // 35: Relay.GetValidatorRegistration:output_type -> GetValidatorRegistrationResponse
	13, // 36: Relay.PreFetchGetPayload:output_type -> PreFetchGetPayloadResponse
	26, // 37: Relay.StreamBuilder:output_type -> StreamBuilderResponse
